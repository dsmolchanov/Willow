...
BEGIN
    ...
    -- Create request with authorization header in URL
    -- Adding the token as a query parameter since we can't set headers
    edge_function_url := edge_function_url || '?auth=' || auth_token;
